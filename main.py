...
def main():
    ...
    humidity_switch_on_off_pin = machine.Pin(
    ...
    while True:
        # Save time at which we started measuring to have more precise
        # sleep duration
        ...
        # Adapt time to sleep (user-defined period minus measurements
        # duration).
        meas_duration = time.time() - measurements_start
        sleep_time = (86400 / config.measurements_per_day) - meas_duration
        print("Deactivated sensor.")
        print(f"Going to sleep now for {round(sleep_time)} seconds.")
        # TODO: use actual deepsleep functionality of pico W instead of
        #   time sleep
